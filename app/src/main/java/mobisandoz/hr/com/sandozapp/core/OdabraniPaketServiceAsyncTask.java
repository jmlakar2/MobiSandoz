 ...
 */
public class OdabraniPaketServiceAsyncTask extends AsyncTask<Object, Void, Object> {
    @Override
    protected Object doInBackground(Object... params) {
        ...
        HttpGet request = new HttpGet(
                "http://178.62.195.200/estud/servisi/getpaket.php?id_nagrade_korisnik="+korisnik_nagrada
        );
