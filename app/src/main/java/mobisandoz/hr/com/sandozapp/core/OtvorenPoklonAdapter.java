 ...
 */
public class OtvorenPoklonAdapter extends BaseAdapter {
    private static ArrayList<String> itemDetailsrrayList;

    private LayoutInflater l_Inflater;

    public OtvorenPoklonAdapter(Context context, ArrayList<String> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.itemImage.setImageResource(R.drawable.poklonot);
