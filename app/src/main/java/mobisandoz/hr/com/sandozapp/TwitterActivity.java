...
public class TwitterActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twitter_lyout);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                Log.e("Prijava nije uspjela", e.getMessage());
            }
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_login:
                ...
                break;
            case R.id.btn_share:
                final String status = "#SandozApp " + mShareEditText.getText().toString();
                ...
                if (status.trim().length() > 0) {
                    ...
                    Login lo = new Login();
                    String user = lo.vratiUser(this);
                    String kod = lo.vratiKod(this);
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Objavljujem na twitteru...");
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(TwitterActivity.this, "Tweet je uspjesno objavljen!", Toast.LENGTH_SHORT).show();
